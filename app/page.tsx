  ...
  const ChatPanel = () => (
    <div style={{ display: "flex", flexDirection: "column", flex: 1, overflow: "hidden" }}>
      ...
      <div style={{ padding: "12px 16px", borderTop: "1px solid " + COLORS.border, background: COLORS.surface, display: "flex", gap: "8px", alignItems: "center" }}>
        ...
        <input value={input} onChange={(e) => setInput(e.target.value)} onKeyDown={(e) => e.key === "Enter" && sendMessage()} placeholder={listening ? "Listening..." : "Type or use mic..."} style={{ flex: 1, background: COLORS.card, border: "1px solid " + (listening ? COLORS.danger : COLORS.border), borderRadius: "10px", padding: "11px 14px", color: COLORS.text, fontSize: "14px", outline: "none" }} />
